...
from aot_cast.onto import Ontology, RDFGraph, OntologyProperties
...
from aot_cast.tool.llm import LLMTool
from aot_cast.tool.ontology_manager import OntologyManager
